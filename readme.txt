...
There are two ways you can use this plugin:
   ...
   1. Add the trigger text <!-- wp_paypal_payment --> to a post or page
   2. Call the function from a template file: <?php echo Paypal_payment_accept(); ?>
...
4. Add the trigger text <!-- wp_paypal_payment --> to a post or page where u want it to appear.

== Frequently Asked Questions ==

1. Does this plugin have shopping cart?
No.

2. Can this plugin be used to accept Donation?
Yes

3. Can this plugin be used to accept paypal payment for a service?
Yes

3. Can this plugin be used to accept paypal payment for a product?
yes
